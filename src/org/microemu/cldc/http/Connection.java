...
public class Connection implements HttpConnection, ConnectionImplementation {
	...
	public javax.microedition.io.Connection openConnection(String name, int mode, boolean timeouts) throws IOException {
		...
		try {
            ...
            String mappedHost = Mobile.addressMappings.getOrDefault(originalHost, originalHost);

            if (!originalHost.equals(mappedHost)) {
                name = name.replace(originalHost, mappedHost);
                url = new URL(name); // Re-parse the URL with the mapped host
            }
