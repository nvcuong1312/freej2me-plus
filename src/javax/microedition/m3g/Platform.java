	...
	static boolean uiThreadAvailable() {
		{
			...
			if (!libraryLoaded) {
				...
				String newPath = "/mnt/sdcard/libs:" + existingPath; // Add your path
				System.setProperty("java.library.path", newPath);
				Mobile.log(Mobile.LOG_INFO, "Loading newPath: " + newPath);
				System.loadLibrary("m3g");
				Mobile.log(Mobile.LOG_INFO, "Loading newPath loaded ");
				libraryLoaded = true;
